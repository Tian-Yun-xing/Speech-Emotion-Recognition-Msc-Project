function [mdl, validationPredictions, validationResponse] = MFCC_KNN(audio_ds,fs,MFCC_Coe,frame_length_sec,overlap_percentage,leave_percentage)
%% Documentation
...
cvp = cvpartition(response, 'Holdout', leave_percentage);
